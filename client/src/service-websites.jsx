        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 sm:pt-24 lg:pt-32 pb-16 sm:pb-24">
          <div className="text-center fade-up">
            <div className="inline-flex items-center space-x-2 bg-emerald-100 border-2 border-emerald-600 rounded-full px-4 sm:px-6 py-2 mb-6 sm:mb-8">
              ...
              <span className="text-xs sm:text-sm font-bold text-emerald-900 tracking-wider">
                SERVICE WEBSITES
              </span>
            </div>
          ...
          >
            <div className="bg-white/80 backdrop-blur-sm border-2 border-emerald-600 rounded-2xl p-6 sm:p-8 card-hover">
              ...
              <h3 className="heading-font text-xl sm:text-2xl font-bold text-emerald-900 mb-2 sm:mb-3">
                Lightning Fast
              </h3>
            ...
            <div
              className="bg-white/80 backdrop-blur-sm border-2 border-emerald-600 rounded-2xl p-6 sm:p-8 card-hover"
              style={{ animationDelay: "0.1s" }}
            >
              <div
                className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-teal-500 to-cyan-500 rounded-xl flex items-center justify-center mb-4 sm:mb-6 float-animation"
            ...
            >
              <div
                className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-cyan-500 to-emerald-500 rounded-xl flex items-center justify-center mb-4 sm:mb-6 float-animation"
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm sm:text-base text-emerald-700">
                          Automatic compression and next-gen formats (WebP,
                          AVIF)
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm sm:text-base text-emerald-700">
                          Content delivered from servers closest to your
                          visitors
                        </p>
                      </div>
                    </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                <div>
                  <div className="inline-block bg-teal-100 border-2 border-teal-600 rounded-full px-4 sm:px-6 py-2 mb-4 sm:mb-6">
                    <span className="text-xs sm:text-sm font-bold text-teal-900 tracking-wider">
                      CONVERSION FOCUSED
                    </span>
                  </div>
                  <h3 className="heading-font text-2xl sm:text-3xl lg:text-4xl font-black text-emerald-900 mb-4 sm:mb-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="bg-gradient-to-br from-teal-50 to-cyan-50 border-2 border-teal-600 rounded-xl p-4 sm:p-6">
                      <div className="text-2xl sm:text-3xl font-black text-teal-900 mb-2">
                        45%
                      </div>
                    ...
                    <div className="bg-gradient-to-br from-cyan-50 to-emerald-50 border-2 border-cyan-600 rounded-xl p-4 sm:p-6">
                      <div className="text-2xl sm:text-3xl font-black text-cyan-900 mb-2">
                        3.2x
                      </div>
                      <p className="text-xs sm:text-sm text-cyan-700 font-bold">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                  ...
                  <div className="bg-gradient-to-br from-cyan-500 to-emerald-600 rounded-3xl p-6 sm:p-8 lg:p-12 shadow-2xl">
                    <div className="grid grid-cols-3 gap-3 sm:gap-4">
                      <div className="bg-white/90 rounded-xl aspect-square flex items-center justify-center">
                        <svg
                          className="w-8 h-8 sm:w-12 sm:h-12 text-cyan-600"
                          fill="currentColor"
                          viewBox="0 0 20 20"
                        >
                      ...
                      <div className="bg-white/90 rounded-xl aspect-square flex items-center justify-center">
                        <svg
                          className="w-8 h-8 sm:w-12 sm:h-12 text-teal-600"
                          fill="currentColor"
                          viewBox="0 0 20 20"
                        >
                          <path
                ...
                <div className="order-1 lg:order-2">
                  <div className="inline-block bg-cyan-100 border-2 border-cyan-600 rounded-full px-4 sm:px-6 py-2 mb-4 sm:mb-6">
                    <span className="text-xs sm:text-sm font-bold text-cyan-900 tracking-wider">
                      RESPONSIVE DESIGN
                    </span>
                  </div>
                  <h3 className="heading-font text-2xl sm:text-3xl lg:text-4xl font-black text-emerald-900 mb-4 sm:mb-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm sm:text-base text-emerald-700">
                          Designed for smartphones first, then scaled up
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm sm:text-base text-emerald-700">
                          Buttons and forms sized perfectly for fingers
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm sm:text-base text-emerald-700">
                          Works perfectly in Chrome, Safari, Firefox, and Edge
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="fade-up bg-white/10 backdrop-blur-sm border-2 border-emerald-400 rounded-2xl p-6 sm:p-8 card-hover">
              <div className="w-12 h-12 sm:w-14 sm:h-14 bg-emerald-400 rounded-xl flex items-center justify-center mb-4 sm:mb-6">
                <svg
                  className="w-6 h-6 sm:w-7 sm:h-7 text-emerald-900"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <p className="text-sm sm:text-base text-emerald-100 leading-relaxed">
                We identify the exact search terms your potential customers use
                and optimize your content to rank for them. Comprehensive
                keyword analysis and competitive research included.
              </p>
            </div>

            <div
              className="fade-up bg-white/10 backdrop-blur-sm border-2 border-teal-400 rounded-2xl p-6 sm:p-8 card-hover"
              style={{ animationDelay: "0.1s" }}
            >
              <div className="w-12 h-12 sm:w-14 sm:h-14 bg-teal-400 rounded-xl flex items-center justify-center mb-4 sm:mb-6">
                <svg
                  className="w-6 h-6 sm:w-7 sm:h-7 text-teal-900"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <p className="text-sm sm:text-base text-teal-100 leading-relaxed">
                Compelling title tags, meta descriptions, and structured data
                markup that make your listings stand out in search results and
                drive higher click-through rates.
              </p>
            </div>

            <div
              className="fade-up bg-white/10 backdrop-blur-sm border-2 border-cyan-400 rounded-2xl p-6 sm:p-8 card-hover"
              style={{ animationDelay: "0.2s" }}
            >
              <div className="w-12 h-12 sm:w-14 sm:h-14 bg-cyan-400 rounded-xl flex items-center justify-center mb-4 sm:mb-6">
                <svg
                  className="w-6 h-6 sm:w-7 sm:h-7 text-cyan-900"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <p className="text-sm sm:text-base text-cyan-100 leading-relaxed">
                ...
                geo-targeted content that helps you dominate search results in
                your service area and attract nearby customers.
              </p>
            </div>

            <div
              className="fade-up bg-white/10 backdrop-blur-sm border-2 border-emerald-400 rounded-2xl p-6 sm:p-8 card-hover"
            ...
            >
              ...
              <p className="text-sm sm:text-base text-emerald-100 leading-relaxed">
                Clean code structure, proper heading hierarchy, XML sitemaps,
                robots.txt optimization, and schema markup that search engines
                love. Technical excellence as standard.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-sm sm:text-base text-teal-100 leading-relaxed">
                Optimized alt text, file names, and compression for every image.
                Makes your visuals discoverable in image search and improves
                overall page performance and rankings.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-sm sm:text-base text-cyan-100 leading-relaxed">
                Strategic content planning that targets buyer intent at every
                stage. Service pages, blog posts, and resources designed to
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            {[
              ...
              >
                <div
                  className={`bg-gradient-to-br ${tech.color} rounded-2xl p-6 sm:p-8 shadow-lg`}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
              <div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-bold text-emerald-900 text-base sm:text-lg mb-2">
                      Future-Proof Architecture
                    </h4>
                    <p className="text-sm sm:text-base text-emerald-700 leading-relaxed">
                      Built with modern frameworks that are actively maintained
                      and continuously improved, ensuring your website stays
              ...
              <div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-emerald-700 leading-relaxed">
                      Industry-standard security practices, SSL encryption,
                      regular updates, and protection against common
                      vulnerabilities keep your data and your customers safe.
                    </p>
                  </div>
                </div>
              </div>
              <div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-emerald-700 leading-relaxed">
                      Cloud-based hosting that grows with your business. Handle
                      traffic spikes effortlessly without performance
              ...
              <div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-emerald-700 leading-relaxed">
                      Intuitive CMS systems that let you update content, add
                      pages, and manage your website without technical knowledge
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                  <div className="lg:text-right">
                    ...
                    <p className="text-base sm:text-lg text-emerald-100 leading-relaxed mb-4 sm:mb-6">
                      ...
                      competitors, and goals. Through in-depth consultations and
                      research, we develop a comprehensive strategy tailored to
                      your unique needs.
                    </p>
                    <div className="space-y-2">
                      <div className="flex items-center space-x-2 lg:justify-end">
                        <span className="text-sm sm:text-base text-emerald-200">
                          Competitor analysis
                        </span>
                        <div className="w-2 h-2 bg-emerald-400 rounded-full"></div>
                      </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                  <div className="lg:order-2">
                    ...
                    <p className="text-base sm:text-lg text-teal-100 leading-relaxed mb-4 sm:mb-6">
                      Our designers create custom mockups and wireframes that
                      bring your vision to life. You'll see exactly how your
                      website will look before we write a single line of code,
                      with unlimited revisions until it's perfect.
                    </p>
                    <div className="space-y-2">
                      <div className="flex items-center space-x-2">
                        <div className="w-2 h-2 bg-teal-400 rounded-full"></div>
                        <span className="text-sm sm:text-base text-teal-200">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                  <div className="lg:text-right">
                    ...
                    <p className="text-base sm:text-lg text-cyan-100 leading-relaxed mb-4 sm:mb-6">
                      Our developers transform designs into a fully functional
                      website using clean, efficient code. Rigorous testing
                      across all devices and browsers ensures everything works
              ...
              <div className="fade-up">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                  <div className="lg:order-2">
                    ...
                    <p className="text-base sm:text-lg text-emerald-100 leading-relaxed mb-4 sm:mb-6">
                      We handle every aspect of the launch, from domain setup to
                      SSL configuration. Post-launch, we provide comprehensive
                      training and ongoing support to ensure your continued
                      success.
                    </p>
                    <div className="space-y-2">
                      <div className="flex items-center space-x-2">
                  ...
                  <div className="lg:order-1 lg:pr-12">
                    <div className="bg-white/10 backdrop-blur-sm border-2 border-emerald-400 rounded-2xl p-6 sm:p-8 card-hover">
                      <div className="flex items-center justify-center mb-6">
                        <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-emerald-400 to-teal-400 rounded-full flex items-center justify-center shadow-lg">
                          <svg
                            className="w-8 h-8 sm:w-10 sm:h-10 text-emerald-900"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
      ...
      <div className="bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 py-16 sm:py-20 lg:py-32">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center fade-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button
              className="w-full sm:w-auto bg-gradient-to-r from-emerald-600 to-teal-600 text-white px-8 sm:px-12 py-4 sm:py-5 rounded-xl font-bold text-base sm:text-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 border-2 border-emerald-700"
