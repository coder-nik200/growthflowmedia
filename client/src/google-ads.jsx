          ...
          <div className="text-center reveal-up">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
              {[
                ...
                >
                  <div className="display-font text-4xl text-yellow-400 mb-2">
                    {stat.value}
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {[
              ...
              <div
                key={idx}
                className="reveal-up hover-lift bg-white rounded-3xl p-8 lg:p-10 shadow-lg"
                style={{ transitionDelay: `${idx * 0.15}s` }}
              >
                <div className="flex items-start space-x-4 mb-6">
                  <div className="text-6xl">{campaign.icon}</div>
                  <div className="flex-1">
                    <h3 className="display-font text-3xl text-gray-900 mb-2">
                      {campaign.title}
                    </h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={idx}
                className="reveal-up bg-white/10 backdrop-blur-sm border-2 border-white/20 rounded-2xl p-8"
                  ...
                  >
                    <div className="flex-1 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl p-8 lg:p-10 shadow-lg">
                      <div className="flex items-center justify-between mb-4">
                        <div className="display-font text-6xl text-blue-600">
                      ...
                      <h3 className="display-font text-3xl text-gray-900 mb-4">
                        {step.title}
                      </h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={idx}
                className="reveal-up bg-gray-800 border-2 border-gray-700 rounded-xl p-6 hover-lift"
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center reveal-up">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <button
              ...
              className="bg-white text-blue-600 px-12 py-6 rounded-full display-font text-lg hover:shadow-2xl transform hover:scale-105 transition-all"
            >
              LETS START
            </button>
          </div>
